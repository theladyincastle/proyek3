(function () {
    ...
    notifier.modal(`<h3 class="font-semibold mb-1 fs-20">Welcome To Bootstrap Admin Template </h3><small class="text-gray-5 fs-14">Click outside the modal window to close it.</small>`, 'demo')
    })
